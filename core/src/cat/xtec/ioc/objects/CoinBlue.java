...
// TODO Exercici 3 - classe moneda
public class CoinBlue extends Scrollable {

    private Circle captureCoinCircle;
    private boolean pause;

    public CoinBlue(float x, float y, float width, float height, float velocity) {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(AssetManager.coins_blue, position.x, position.y, this.getOriginX(), this.getOriginY(), width, height, this.getScaleX(), this.getScaleY(), this.getRotation());
    }


    //Mètode per saber si l'hem capturat
    public boolean captureCoinBlue(Spacecraft nau) {
